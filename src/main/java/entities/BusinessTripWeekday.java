...
@Entity
@Table(name = "business_trip_weekdays", schema = "public")
public class BusinessTripWeekday extends Event{
...
//    private int year;
    ...
    public BusinessTripWeekday(Employee employee, LocalDate dateOfEvent) {
        this.employee = employee;
        this.dateOfEvent = dateOfEvent;

    }

    public BusinessTripWeekday() {
    }
